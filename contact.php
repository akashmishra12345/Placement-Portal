...
<head>
	...
	<title>HireTre - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> RajNagar Extension, <br/> Ghaziabad <br/></address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:contact@hiretre.com">contact@hiretre.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+919555761964">+91-9555761964</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About HireTre</h5>
											<p>HireTre connects top talent with leading employers, simplifying the hiring process to make dream jobs a reality for job seekers and perfect candidates a reality for employers.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">HireTre Contact</h5>
								
								<p>Address : RajNagar Extension, Ghaziabad</p>
								<p>Email : <a href="mailto:contact@hiretre.com">contact@hiretre.com</a></p>
								<p>Phone : <a href="tel:+919555761964">+91-9555761964</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> HireTre Software Solution</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Vivek Kumar Gupta</a></li>
								</ul>
