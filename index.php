...
<head>
	...
	<title>HireTre - Job Portal</title>
    ...
    <meta property="og:image:alt" content="HireTre" />
...
<body class="Home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/bg.jpg');">
				<div class="container">

					<h1>Your bright future starts here now</h1>
					<p>Finding your next job or career on HireTre</p>
